    ...
    <section id="skills" className="py-14 pb-10">
      <div className="container mx-auto px-4 font-playfair">
                ...
                <motion.h2
                  ...
                  whileInView="visible"
                >
                  The <span className="text-secondry">Skills</span> I have
                </motion.h2>
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-4">
          {skills.map((skill, index) => (
            <motion.div
              ...
              initial="hidden"
              whileInView="visible"
              className="bg-[#e5b3fe] text-white text-center py-6 rounded-md shadow-md transform transition duration-300 ease-in-out hover:scale-105 hover:bg-secondry group"
            >
              <div className="flex justify-center mb-2 text-4xl text-secondry group-hover:text-white transition duration-300">
                {skill.icon}
              </div>
