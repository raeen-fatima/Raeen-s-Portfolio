    ...
    <div id='contact' className="border-b border-neutral-900 pt-14 pb-20 font-playfair">
      ...
      {formStatus && (
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="text-center text-lg text-secondry mb-5"
        >
          {formStatus}
        </motion.div>
      )}
      ...
      >
        ...
        <div className="col-span-1">
          <input
            ...
            className="w-full bg-transparent border-b border-gray-600 text-secondry focus:outline-none focus:border-secondry py-2"
            required
          />
        </div>
        ...
        >
          <button
            type="submit"  
            className="bg-secondry text-black px-6 py-3 rounded-lg text-sm font-semibold hover:bg-white   focus:outline-none"
          >
