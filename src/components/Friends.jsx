...
const Friends = () => {
  ...
  const feedbackData = [
    ...
    },
    {
      ...
      feedback:
        "Her positive attitude and enthusiasm always brighten up the room!",
      imgSrc: " ",
      linkedIn: "https://www.linkedin.com/in/ashyam-siddiqui-a6b0b8342",
    },
    {
      name: "Ruby Poddar",
      feedback:"Raeen is an exceptional individual, known for her dedication and hard work. Her passion for achieving her goals inspires those around her",
      imgSrc: rubyImg,
    ...
    <div id='friends' className="py-16 px-8  text-white font-playfair">
      ...
      <div className="feedback-slider px-4">
        ...
        >
          {feedbackData.map((feedback, index) => (
            <motion.div
              key={index}
              className={`relative bg-secondry p-6 rounded-lg shadow-lg transition-all duration-300 ${
                hoveredCard === index
      ...
      >
        <a
          ...
          className="bg-secondry text-black px-8 py-3 rounded-full shadow-lg font-bold hover:bg-white  transition-all duration-300"
        >
          Send Your Feedback
        </a>
      </motion.div>
